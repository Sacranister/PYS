...
class ImagensControllerTest < ActionController::TestCase
  ...
  test "should create imagen" do
    assert_difference('Imagen.count') do
      post :create, imagen: { imagen_uri: @imagen.imagen_uri, ins_cod: @imagen.ins_cod, ins_cod_prov: @imagen.ins_cod_prov }
    end
  ...
  test "should update imagen" do
    patch :update, id: @imagen, imagen: { imagen_uri: @imagen.imagen_uri, ins_cod: @imagen.ins_cod, ins_cod_prov: @imagen.ins_cod_prov }
    assert_redirected_to imagen_path(assigns(:imagen))
  end
