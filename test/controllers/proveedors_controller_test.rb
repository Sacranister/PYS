...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { pro_desc: @proveedor.pro_desc, pro_mail: @proveedor.pro_mail, pro_nom: @proveedor.pro_nom, pro_web: @proveedor.pro_web }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { pro_desc: @proveedor.pro_desc, pro_mail: @proveedor.pro_mail, pro_nom: @proveedor.pro_nom, pro_web: @proveedor.pro_web }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
